...
class Distribution {
    ...
    putProductInBag(productId) {
        ...
        _.forEach(productRecursiveInfo, (value, index) => {
            ...
            let secondLevelRecorder = this.orderExpressBagInfo[serviceInfo._id].secondInfo[secondLevelServiceId];
            let topLevelRecorder = this.orderExpressBagInfo[serviceInfo._id].topInfo;
